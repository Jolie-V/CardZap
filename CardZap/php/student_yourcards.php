...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/student_yourcards.css?v=2" />
    <script src="../javascript/student_yourcards.js" defer></script>
  </head>
  <body>
      ...
      <aside class="sidebar">
        ...
        <nav>
          <ul class="nav-list">
            ...
            <li><a class="nav-item active" href="student_yourcards.php">Your Cards</a></li>
