...
<html lang="en">
  <head>
    ...
    <title>CardZap • Edit Quiz Cards</title>
    <link rel="stylesheet" href="../css/editquiz.css?v=1" />
  </head>
  <body>
    <div class="app">
      <!-- Sidebar -->
      ...
      <!-- Topbar -->
      <header class="topbar">
        <div class="page-title">Edit Quiz Cards</div>
    ...
    <script src="../javascript/editquiz.js?v=1"></script>
  </body>
  </html>
