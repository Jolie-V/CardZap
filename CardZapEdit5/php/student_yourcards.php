...
<html lang="en">
  <head>
    ...
    <?php
      $v_css_yourcards = @filemtime(__DIR__ . '/../css/student_yourcards.css') ?: time();
      $v_css_main = @filemtime(__DIR__ . '/../css/main.css') ?: time();
      $v_js_yourcards = @filemtime(__DIR__ . '/../javascript/student_yourcards.js') ?: time();
    ?>
    <link rel="stylesheet" href="../css/student_yourcards.css?v=<?php echo $v_css_yourcards; ?>" />
    <link rel="stylesheet" href="../css/main.css?v=<?php echo $v_css_main; ?>" />
    <script src="../javascript/student_yourcards.js?v=<?php echo $v_js_yourcards; ?>" defer></script>
  </head>
  <body>
