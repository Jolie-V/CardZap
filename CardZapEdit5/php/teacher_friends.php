...
<head>
  ...
  <link rel="stylesheet" href="../css/teacher_friends.css" />
</head>
<body>
  <div class="app">
    <!-- Sidebar -->
    <aside class="sidebar">
      ...
      <nav>
        <ul class="nav-list">
          ...
          <li><a class="nav-item active" href="teacher_friends.php">Friends</a></li>
  ...
  <script src="../javascript/teacher_friends.js"></script>
</body>
</html>