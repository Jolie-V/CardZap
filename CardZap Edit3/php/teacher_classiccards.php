...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/teacher_classiccards.css?v=<?php echo time(); ?>">
  </head>
  ...
  <body>
    ...
    <script>
      (function ensureTypeParam(){
        ...
        if (!url.searchParams.get('type')) { url.searchParams.set('type', 'teacher'); window.history.replaceState({}, '', url.toString()); }
      })();
    </script>
    <script src="../javascript/teacher_classiccards.js?v=<?php echo time(); ?>"></script>
  </body>
</html>
