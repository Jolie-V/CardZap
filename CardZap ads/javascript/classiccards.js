...
// === Flashcard Flip ===
// Toggles between question and answer on card click.
flashcard.addEventListener('click', () => {
  isFlipped = !isFlipped;
  flashcard.classList.toggle('flipped', isFlipped);
  
  // Update visual feedback for answer areas
...
document.getElementById('saveExitBtn').addEventListener('click', () => {
  ...
  } else if (document.referrer.includes('student_enrolled') || document.referrer.includes('student_yourcards')) {
    window.location.href = 'student_yourcards.php';
  } else {
    // Default fallback - try to determine from URL parameters
